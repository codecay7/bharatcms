...
export interface ApiInvoiceInvoice extends Schema.CollectionType {
  ...
  info: {
    description: 'GST invoices generated for payments';
    displayName: 'Invoice';
    pluralName: 'invoices';
  ...
  attributes: {
    buyer_address: Attribute.Text;
    buyer_email: Attribute.Email;
    buyer_gstin: Attribute.String;
    buyer_name: Attribute.String;
    cgst: Attribute.Decimal;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::invoice.invoice',
      'oneToOne',
    ...
    > &
      Attribute.Private;
    igst: Attribute.Decimal;
    invoice_number: Attribute.String & Attribute.Required & Attribute.Unique;
    items: Attribute.JSON;
    payment_id: Attribute.String;
    seller_gstin: Attribute.String & Attribute.DefaultTo<'GS29AABCU9603R1ZX'>;
    sgst: Attribute.Decimal;
...
export interface ApiTenantTenant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    name: Attribute.String;
    owner_clerk_id: Attribute.String;
    plan: Attribute.Enumeration<
      ['hobby', 'starter', 'pro', 'business', 'lifetime']
    >;
    publishedAt: Attribute.DateTime;
